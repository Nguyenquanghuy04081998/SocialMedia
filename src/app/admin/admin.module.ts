...
@NgModule({
  declarations: [AdminComponent, AccountComponent, PostComponent, HomeComponent, DetailComponent, AuthorizationComponent, DetaiPostComponent, AppreciatedComponent, AverageComponent, PoorlyComponent, AdminCommentComponent, ForgotComponent],
  imports: [
    CommonModule,
    AppRoutingModule,
    MatCardModule,
