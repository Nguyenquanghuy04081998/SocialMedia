...
export class ForgotComponent implements OnInit {
  ...
  select;
  users;
  constructor(private apiService: ApiService, public dialog: MatDialog,private dialogRef: MatDialogRef<ForgotComponent>,
  ...
  resetPassword(user){
    ...
    if (result === true) {
      this.apiService.post('/users/forgot/resetPassAndSendEmail',{email:user.email}).subscribe(e=>{
        this.reset();
       })
    }
    return;
